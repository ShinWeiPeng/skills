...
Invoke `$govern-modular-event-architecture` and apply its evidence-calibrated
Flow cost review when a proposal creates or changes an end-to-end Flow, callback, event,
