...
> [`SPEC-0013`](../../specs/SPEC-0013-shared-skill-distribution.md). The repository
> now keeps the bucketed roots authoritative and deterministically assembles the
> flat native Plugin artifact instead of committing duplicate Skill copies.
