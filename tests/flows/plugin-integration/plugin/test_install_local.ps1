...
$pluginShell = [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot '../../../../plugins/governed-engineering-skills'))
...
$fakeCodex = Join-Path $PSScriptRoot '../support/installer/fake-codex.cmd'
$fakeMarketplaceCodex = Join-Path $PSScriptRoot '../support/installer/fake-marketplace-codex.cmd'
$fakeCodexAccessDenied = Join-Path $PSScriptRoot '../support/installer/fake-codex-access-denied.cmd'
$fakeUriLauncher = Join-Path $PSScriptRoot '../support/installer/fake-uri-launcher.cmd'
$fakePythonFailure = Join-Path $PSScriptRoot '../support/installer/fake-python-failure.cmd'
$fakePythonIncompatible = Join-Path $PSScriptRoot '../support/installer/fake-python-incompatible.cmd'
$fakePythonLauncher = Join-Path $PSScriptRoot '../support/installer/fake-python-launcher.cmd'
$fakePython2 = Join-Path $PSScriptRoot '../support/installer/fake-python2.cmd'
$fakePythonMalformed = Join-Path $PSScriptRoot '../support/installer/fake-python-malformed.cmd'
$fakePythonCompatibleRuntime = Join-Path $PSScriptRoot '../support/installer/fake-python-compatible-runtime.cmd'
$fakePythonProbeFailure = Join-Path $PSScriptRoot '../support/installer/fake-python-probe-failure.cmd'
$fakeArtifactAccess = Join-Path $PSScriptRoot '../support/installer/fake-artifact-access.ps1'
