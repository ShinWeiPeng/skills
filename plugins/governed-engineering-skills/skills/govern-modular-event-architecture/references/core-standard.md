...
1. Every governed production named type MUST have exactly one semantic owner Module and one source declaration in the supported schema 2.1.0/2.2.0 Type Catalog.
