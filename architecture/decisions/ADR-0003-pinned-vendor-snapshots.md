...
> Superseded by `SPEC-0013`. Promoted repository buckets now own the Skills
> directly; deterministic artifact assembly and its complete content fingerprint
> replace vendored snapshots and `vendor-lock.json`.
