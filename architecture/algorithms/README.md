...
| Verification ladder selection and evidence authority | `verification_ladder_domain` | Triggered: additive hard triggers, project bindings, ordered evidence authority, and fail-closed reference resolution determine required validation layers | [ALG-0007](ALG-0007-verification-ladder-selection.md) |
