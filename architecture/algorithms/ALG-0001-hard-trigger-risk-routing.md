...
Rules are versioned in `routing-rules.json`. Adding, removing, or reclassifying a term requires fixture updates, algorithm review, deterministic Plugin assembly, and compatibility-inventory validation. Contract fields remain backward compatible within the declared Plugin version.
