...
- **Owned State:** None
- **Side Effects:** Admit and atomically apply one hash-checked file replacement through the managed delivery CLI, leaving arbitrary host tools outside enforcement. (`-`)
- **Errors:** None
...
- **Entrypoints:** [`implement`](../../skills/engineering/implement/SKILL.md) (skill)<br>[`assess_delivery_spec_context`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`manage_delivery_discussion`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`assess_delivery_turn_context`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`verify_delivery_admission`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`main`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`execute_request`](../../skills/engineering/implement/scripts/managed_delivery.py) (function)<br>[`audit_trace`](../../skills/engineering/implement/scripts/managed_delivery.py) (function)<br>[`main`](../../skills/engineering/implement/scripts/managed_delivery.py) (function)<br>[`assess_delivery_compatibility`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)
- **Public Symbols:** [`implement`](../../skills/engineering/implement/SKILL.md) (skill)<br>[`assess_delivery_spec_context`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`manage_delivery_discussion`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`assess_delivery_turn_context`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`verify_delivery_admission`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`main`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)<br>[`execute_request`](../../skills/engineering/implement/scripts/managed_delivery.py) (function)<br>[`audit_trace`](../../skills/engineering/implement/scripts/managed_delivery.py) (function)<br>[`main`](../../skills/engineering/implement/scripts/managed_delivery.py) (function)<br>[`assess_delivery_compatibility`](../../skills/engineering/implement/scripts/spec_delivery.py) (function)
...
- **Owned State:** None
- **Side Effects:** Persist project and task scoped execution receipts; suspend product authority independently of SPEC discussion. (`-`); Atomically persist one canonical project-root SPEC Markdown snapshot with structured, visibly redacted Discussion Context and embed its normalized audit without full transcripts or hidden-reasoning prose; discussion observations may include bounded redacted goals, summaries and candidate metadata with sources. (`-`); Materialize one decision-complete canonical specification under specs/. (`-`)
...
- **Entrypoints:** [`spec-governance`](../../skills/engineering/spec-governance/SKILL.md) (skill)<br>[`main`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (cli)<br>[`project_state_lock`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`check_spec_dependencies`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`assess_turn_context`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`discussion_request`](../../skills/engineering/spec-governance/scripts/discussion_state.py) (function)<br>[`assess_discussion_completion`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`finish_discussion_turn`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`record_question`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`question_surface_policy`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`update_question`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`pending_decision`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`execution_binding`](../../skills/engineering/spec-governance/scripts/execution_state.py) (function)<br>[`read_execution_state`](../../skills/engineering/spec-governance/scripts/execution_state.py) (function)<br>[`write_execution_state`](../../skills/engineering/spec-governance/scripts/execution_state.py) (function)<br>[`assess_execution_compatibility`](../../skills/engineering/spec-governance/scripts/execution_state.py) (function)
- **Public Symbols:** [`spec-governance`](../../skills/engineering/spec-governance/SKILL.md) (skill)<br>[`main`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`project_state_lock`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`check_spec_dependencies`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`assess_turn_context`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`discussion_request`](../../skills/engineering/spec-governance/scripts/discussion_state.py) (function)<br>[`assess_discussion_completion`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`finish_discussion_turn`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`record_question`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`question_surface_policy`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`update_question`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`pending_decision`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`execution_binding`](../../skills/engineering/spec-governance/scripts/execution_state.py) (function)<br>[`read_execution_state`](../../skills/engineering/spec-governance/scripts/execution_state.py) (function)<br>[`write_execution_state`](../../skills/engineering/spec-governance/scripts/execution_state.py) (function)<br>[`assess_spec_evidence_update`](../../skills/engineering/spec-governance/scripts/spec_contract.py) (function)<br>[`assess_execution_compatibility`](../../skills/engineering/spec-governance/scripts/execution_state.py) (function)
...
| `spec-governance.start` | `spec_governance_domain` | input | command | sync | Create, migrate, or resolve one canonical project-root working specification with embedded audit.: Project root, change-set slug and optional working, task, or branch evidence produce one immutable WorkingSpecReference. | `spec-governance` |
